const domain = process.env.NEXT_PUBLIC_SHOPIFY_DOMAIN || 'dein-shop-name.myshopify.com';
const storefrontAccessToken = process.env.NEXT_PUBLIC_SHOPIFY_TOKEN || 'dein_access_token';
