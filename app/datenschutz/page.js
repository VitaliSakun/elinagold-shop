    ...
    <>
      <div className="bg-white min-h-screen">
        <main className="max-w-3xl mx-auto px-5 md:px-8 py-16 md:py-28 font-sans">
          ...
          <ul className="text-[13px] md:text-[14px] font-light leading-7 text-stone-600 mt-3 space-y-2 list-disc list-inside">
          ...
          <ul className="text-[13px] md:text-[14px] font-light leading-7 text-stone-600 mt-3 space-y-3 list-disc list-inside">
            <li>
