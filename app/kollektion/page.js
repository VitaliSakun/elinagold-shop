  ...
  return (
    <div className="min-h-screen bg-[#f9f8f4] pt-22 md:pt-32">
      ...
      <div className="text-center py-8 md:py-12 px-5 md:px-8">
        <h1 className="text-2xl md:text-4xl font-light tracking-[0.3em] uppercase text-black mb-3 md:mb-4">
          Kollektionen
        </h1>
        ...
        {items.map((col) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-end pb-8 md:pb-12 text-white">
              <h2 className="text-xl md:text-3xl font-light tracking-[0.25em] md:tracking-[0.3em] uppercase mb-2 md:mb-3">
                {col.title}
              </h2>
