    ...
    <>
      <div className="bg-white min-h-screen">
        <main className="max-w-3xl mx-auto px-5 md:px-8 py-16 md:py-28 font-sans">
          ...
          <p className="text-[13px] md:text-[14px] font-normal leading-7 text-stone-600 mb-8">
          ...
          <ul className="text-[13px] md:text-[14px] font-normal leading-7 text-stone-600 mt-3 space-y-1.5 list-disc list-inside">
