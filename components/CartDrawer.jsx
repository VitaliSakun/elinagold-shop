      ...
      >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link
                        href={`/produkt/${line.merchandise?.product?.handle}`}
                        onClick={() => setCartOpen(false)}
                        className="text-[11px] tracking-[0.1em] uppercase font-medium text-black hover:opacity-60 transition-opacity leading-tight block mb-1"
                      >
                      ...
                      <p className="text-[11px] font-medium text-stone-600 mb-3">
                        {fmt(price)} €
                      </p>
                      ...
                      <div className="flex items-center gap-0">
                        ...
                        <span className="w-8 text-center text-[11px] font-medium border-t border-b border-stone-200 h-7 flex items-center justify-center">
                          {line.quantity}
                        </span>
                        <button
        ...
        {lines.length > 0 && (
          <div className="border-t border-stone-100 px-5 md:px-8 py-5 md:py-6 bg-white">
            ...
            <p className="text-[9px] text-stone-400 font-medium mb-6">
