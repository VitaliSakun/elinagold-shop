  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-5 md:px-6 md:py-6">
        {/* Text */}
        <p className="text-[12px] md:text-[13px] font-light leading-6 text-stone-600 font-sans mb-4">
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:gap-3">
          <button
            ...
            className="flex-1 bg-[#641428] text-white text-[11px] tracking-[0.2em] uppercase font-sans font-light py-3 px-5 hover:bg-[#4e0f1e] active:opacity-80 transition-colors"
          >
            Alle akzeptieren
          </button>
          <button
            onClick={handleDecline}
            className="flex-1 border border-stone-300 text-stone-700 text-[11px] tracking-[0.2em] uppercase font-sans font-light py-3 px-5 hover:border-stone-500 hover:text-stone-900 active:opacity-70 transition-colors"
          >
            Nur notwendige
          </button>
        </div>
